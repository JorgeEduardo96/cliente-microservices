package br.com.microservices.clientecadastro.validaton;
...
@Target({ FIELD })
@Retention(RUNTIME)
@Constraint(validatedBy = { LevelSenha.SegurancaSenhaValidator.class })
public @interface LevelSenha {
    ...
    class SegurancaSenhaValidator implements ConstraintValidator<LevelSenha, String> {
        ...
        public boolean isValid(String senha, ConstraintValidatorContext context) {
            ...
            for (RequisitosSenha requisito : requisitosParaValidar) {
                regex.append(requisito.getRegexValidacao());
            }
            regex.append(".*");
            return Pattern.compile(regex.toString()).matcher(senha).matches();
        }
    }
